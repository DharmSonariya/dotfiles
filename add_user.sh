...
if [[ $(uname -r) == *.amzn2.x86_64 ]]; then
    sh -c "$(curl -fsSL https://raw.githubusercontent.com/DharmSonariya/dotfiles/master/el7_sudo_init.sh)" &&
    ...
    sh -c "$(curl -fsSL https://raw.githubusercontent.com/DharmSonariya/dotfiles/master/el8_sudo_init.sh)" &&
