...
if [[ $(uname -r) == *.amzn2.x86_64 ]]; then
    curl -fsSL https://raw.githubusercontent.com/DharmSonariya/dotfiles/master/el7_sudo_init.sh | sh &&
    ...
    curl -fsSL https://raw.githubusercontent.com/DharmSonariya/dotfiles/master/el8_sudo_init.sh | sudo sh &&
    curl -fsSL https://raw.githubusercontent.com/DharmSonariya/dotfiles/master/el8_user_init.sh | sudo -u $USERNAME sh
else
